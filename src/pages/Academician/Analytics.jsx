...
export default function Analytics() {
  ...
  const PROFICIENCY_DOMAINS = [
    { name: "Full-Stack Web Development (React / Node)", keywords: ["react", "node", "javascript", "web"], color: "bg-blue-600", text: "text-blue-700" },
    { name: "Core Data Structures & Algorithms", keywords: ["dsa", "c++", "java", "algorithms"], color: "bg-blue-600", text: "text-blue-700" },
    { name: "Database Engineering & SQL", keywords: ["sql", "database", "mongodb", "postgresql"], color: "bg-indigo-600", text: "text-indigo-700" },
    { name: "Machine Learning & PyTorch Frameworks", keywords: ["pytorch", "machine learning", "deep learning", "tensorflow", "python"], color: "bg-amber-500", text: "text-amber-700" },
    { name: "Cloud DevOps (Docker / Kubernetes)", keywords: ["docker", "kubernetes", "aws", "cloud", "devops"], color: "bg-purple-600", text: "text-purple-700" }
  ];
  ...
  return (
    <div className="space-y-8 pb-16">
      ...
      <div>
        ...
        <h1 className="text-2xl font-extrabold text-slate-900 mt-1">Mentee Skill Gap & Placement Trends</h1>
        <p className="text-xs text-slate-600 mt-1">
          Live real-time aggregation across {students.length} assigned students under <span className="text-blue-700 font-bold">{currentUser?.name || 'this mentor'}</span>
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-xs space-y-6">
          <h3 className="text-lg font-bold text-slate-900 flex items-center gap-2">
            <TrendingUp className="w-5 h-5 text-blue-600" /> Mentee Skill Proficiency Distribution
          </h3>

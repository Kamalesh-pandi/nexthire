  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 pb-16">
      ...
      <div>
        ...
        <h1 className="text-2xl font-extrabold text-slate-100 mt-1">Post Job or Internship Opportunity</h1>
      </div>
      ...
      <div className="glass-panel rounded-3xl p-6 sm:p-8 border border-slate-700/80 space-y-6">
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-800 border border-slate-700 rounded-xl px-4 py-2.5 text-xs text-white placeholder-slate-400 focus:outline-none focus:border-purple-500"
              />
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              <label className="text-xs font-semibold text-slate-300 block mb-1">Stipend / CTC</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="text-xs font-semibold text-slate-300 block mb-1">Application Deadline</label>
              <input
                type="date"
          ...
          <div>
            <label className="text-xs font-semibold text-slate-300 block mb-1">Required Skills (AI Match Tagging)</label>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-slate-800 border border-slate-700 rounded-xl px-4 py-3 text-xs text-white placeholder-slate-400 focus:outline-none focus:border-purple-500"
            />
          </div>
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-slate-700">
            <button
              type="submit"
              className="px-8 py-3 rounded-2xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold text-xs shadow-xl shadow-purple-500/25 flex items-center gap-2"
            >
